...
# from sklearn.metrics import auc, f1_score, roc_curve, precision_score, recall_score, confusion_matrix
...
def cal_sample_weight(labels, num_class, use_sample_weight=True):
    ...
    # class_samples = [431, 1107, 343, 670]
    # class_samples = [204, 115, 68, 63]
    class_samples = [100, 100, 100, 100]

    sample_weight = np.zeros(labels.shape)
    for i in range(num_class):
        sample_weight[np.where(labels == i)[0]] = 450/class_samples[i]
...
def compute_cohort_metrics(test_pred, gt_labels, cohort):
    ...
    test_cohorts = np.array(['gse13067', 'gse13294', 'gse14333', 'gse17536', 'gse20916', 'gse2109',
