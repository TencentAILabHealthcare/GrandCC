...
from load_CRCSC_data import load_external_features, CRC_Dataset, construct_graph
...
if __name__ == "__main__":
    ...
    te_features, te_labels, _, te_sample_ids, match_flag = load_external_features(file_name = opt.external_file)
